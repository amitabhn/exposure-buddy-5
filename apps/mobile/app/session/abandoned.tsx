...
const styles = StyleSheet.create({
  ...
  message: { fontSize: 18, color: color.content.secondary, textAlign: 'center', lineHeight: 28, marginBottom: 48 },
  returnButton: { paddingVertical: 12, alignItems: 'center' },
  returnText: { fontSize: 14, color: color.content.secondary, textDecorationLine: 'underline' },
})
