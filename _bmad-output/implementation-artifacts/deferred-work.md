...
### FIX APPLIED — verification pending: `onboarding` shard's "Send code" tap used a stale `index: 1` disambiguator (found 2026-09-21, via the first real CI run of the `launchApp` fix above)
...
- **Verification:** pending the next CI run on PR #69.
